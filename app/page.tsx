    ...
    <main className="bg-slate-950">
        ...
        <div className="mx-auto grid max-w-6xl gap-12 px-6 py-24 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-6 text-lg text-slate-300">
              The IPPAN Foundation is the steward of the IPPAN Network—an energy-efficient, massively scalable public
              blockchain built to support real-time financial transactions, machine-to-machine payments, and verifiable
              data availability across the globe.
            </p>
            <p className="mt-4 text-lg text-slate-300">
              We foster a secure, open, and resilient digital ecosystem where developers, businesses, and communities
              can build, innovate, and connect—free from centralized control.
            </p>
            <p className="mt-4 text-base text-slate-400">
              Through public-good research, transparent treasury management, and collaborative governance, the
              Foundation keeps the IPPAN protocol credibly neutral while advancing real-world adoption across finance,
              mobility, supply chains, and climate-resilient infrastructure.
            </p>
          ...
          <div className="grid gap-6 rounded-3xl border border-slate-800 bg-slate-900/70 p-8 shadow-xl shadow-indigo-500/5 backdrop-blur">
            ...
            <p className="text-sm text-slate-300">
              Founded to protect the core protocol, govern open standards, and support ecosystem growth, the Foundation
              ensures the network remains neutral, decentralized, and censorship-resistant for the next generation of
        ...
        <div className="grid gap-16 lg:grid-cols-[1.5fr,1fr] lg:items-start">
          <div>
            ...
            <p className="mt-6 text-slate-300">
              As a non-profit organization, the IPPAN Foundation is committed to advancing the adoption and long-term
              sustainability of the IPPAN Network. We maintain and evolve the protocol, support developers and
              builders, and promote fair access and global participation so anyone can contribute to network resilience.
            </p>
            <div className="mt-10 grid gap-6 sm:grid-cols-2">
              <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-6 shadow-lg shadow-slate-950/40">
                ...
                <p className="mt-3 text-sm text-slate-300">
                  Maintain and evolve the IPPAN protocol for security, performance, and interoperability with open
                  standards.
                </p>
              </div>
              <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-6 shadow-lg shadow-slate-950/40">
                ...
                <p className="mt-3 text-sm text-slate-300">
                  Provide open tools, grants, and technical resources so innovators can launch applications with
                  confidence.
                </p>
              </div>
              <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-6 shadow-lg shadow-slate-950/40">
                ...
                <p className="mt-3 text-sm text-slate-300">
                  Enable anyone to run nodes, earn rewards, and shape the network&apos;s future through transparent
                  governance.
                </p>
              </div>
              <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-6 shadow-lg shadow-slate-950/40">
          ...
          <aside className="rounded-3xl border border-slate-800 bg-slate-900/60 p-8 shadow-xl shadow-slate-950/40">
            ...
            <ul className="mt-6 space-y-4 text-sm text-slate-300">
              <li>
                <span className="font-medium text-slate-100">Developer Grants:</span> Funding open-source tools,
                libraries, and decentralized applications.
              </li>
              <li>
                <span className="font-medium text-slate-100">Infrastructure Incentives:</span> Supporting node operators
                and validators with fair rewards.
              </li>
              <li>
                <span className="font-medium text-slate-100">Education & Outreach:</span> Advancing blockchain literacy
                and training the next generation of builders.
              </li>
              <li>
                <span className="font-medium text-slate-100">Partnerships & Alliances:</span> Collaborating with
                academia, enterprises, and standards bodies worldwide.
              </li>
            </ul>
          </aside>
        </div>
      ...
      <section id="technology" className="border-y border-slate-900 bg-slate-900 text-slate-100">
        <div className="mx-auto grid max-w-6xl gap-12 px-6 py-24 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-6 text-slate-300">
              IPPAN introduces breakthrough innovations designed for real-world scale, enabling trust-minimized
              collaboration across finance, IoT, and data services.
            </p>
          </div>
          <dl className="grid gap-6 text-sm text-slate-100">
            <div className="rounded-2xl border border-slate-700/60 bg-slate-800/50 p-6">
              ...
              <dd className="mt-2 text-slate-200">
                Deterministic, cryptographically verifiable time sequencing up to microsecond precision.
              </dd>
            </div>
            <div className="rounded-2xl border border-slate-700/60 bg-slate-800/50 p-6">
              <dt className="text-lg font-semibold">Energy-Efficient BlockDAG</dt>
              <dd className="mt-2 text-slate-200">
                Achieves millions of transactions per second without wasteful mining or congestion.
              </dd>
            </div>
            <div className="rounded-2xl border border-slate-700/60 bg-slate-800/50 p-6">
              <dt className="text-lg font-semibold">Self-Healing P2P Network</dt>
              <dd className="mt-2 text-slate-200">
                Global node discovery and data availability remain resilient even in extreme conditions.
              </dd>
            </div>
            <div className="rounded-2xl border border-slate-700/60 bg-slate-800/50 p-6">
              <dt className="text-lg font-semibold">Human-Readable Naming</dt>
              <dd className="mt-2 text-slate-200">
                Secure @handles and premium domains tied to cryptographic keys for effortless onboarding.
              </dd>
            </div>
            <div className="rounded-2xl border border-slate-700/60 bg-slate-800/50 p-6">
              <dt className="text-lg font-semibold">M2M Payments & IoT Integration</dt>
              <dd className="mt-2 text-slate-200">
                Instant, cost-efficient transactions between devices built for the autonomous economy.
              </dd>
            </div>
          </dl>
        </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-24">
        <div className="grid gap-12 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-6 text-slate-300">
              The IPPAN Foundation ensures the network remains trustless and community-driven. Protocol upgrades,
              parameters, and treasury allocations are handled transparently, with community input every step of the way.
            </p>
            <ul className="mt-8 space-y-4 text-sm text-slate-300">
              <li>
                <span className="font-medium text-slate-100">Open Governance:</span> Major protocol decisions are openly
                debated, documented, and ratified.
              </li>
              <li>
                <span className="font-medium text-slate-100">Foundation Reserves:</span> Allocated responsibly to
                research, development, and ecosystem growth.
              </li>
              <li>
                <span className="font-medium text-slate-100">Compliance & Neutrality:</span> Supporting global
                participation while respecting regional frameworks.
              </li>
            </ul>
          </div>
          ...
          <div className="rounded-3xl border border-slate-800 bg-slate-900/60 p-8 shadow-xl shadow-slate-950/40">
            ...
            <p className="mt-4 text-sm text-slate-300">
              IPPAN is open to everyone—developers, entrepreneurs, researchers, and enthusiasts. Choose your path to
              contribute.
            </p>
            <ul className="mt-6 space-y-4 text-sm text-slate-300">
              <li>
                <span className="font-medium text-slate-100">Run a Node:</span> Strengthen security and earn rewards by
                operating infrastructure.
              </li>
              <li>
                <span className="font-medium text-slate-100">Build on IPPAN:</span> Launch applications, integrate IoT
                networks, and deliver real-time financial services.
              </li>
              <li>
                <span className="font-medium text-slate-100">Contribute & Propose:</span> Join the conversation on
                protocol evolution and standards.
              </li>
              <li>
                <span className="font-medium text-slate-100">Support the Foundation:</span> Become a partner or donor to
      ...
      <section className="border-t bg-slate-900">
        <div className="mx-auto max-w-6xl px-6 py-24">
          ...
          <p className="mt-6 text-lg text-slate-300">
            Get quick answers about the IPPAN Network&apos;s vision, sustainability commitments, and how the Foundation
            collaborates with builders to accelerate decentralized infrastructure adoption.
          </p>
          <dl className="mt-10 space-y-6">
            {faqItems.map((item) => (
              <div
                key={item.question}
                className="rounded-3xl border border-slate-800 bg-slate-900/60 p-8 shadow-xl shadow-slate-950/40"
              >
                <dt className="text-xl font-semibold text-slate-100">{item.question}</dt>
                <dd className="mt-3 text-base text-slate-300">{item.answer}</dd>
              </div>
            ))}
          </dl>
        </div>
